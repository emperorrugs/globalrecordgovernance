...
const translations: Record<string, Record<Language, string>> = {
  ...
  "footer.invented": { en: "Global Record Governance Framework — Invented and Owned by Tarek Wahid · Canadian Patent Application No. CA 3,300,102", fr: "Cadre mondial de gouvernance des registres — Inventé et détenu par Tarek Wahid · Demande de brevet canadien no CA 3,300,102", ar: "إطار حوكمة السجلات العالمي — اختراع وملكية طارق وحيد · طلب براءة اختراع كندي رقم CA 3,300,102" },
