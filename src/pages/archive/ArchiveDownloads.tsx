...
const categories: { id: string; label: string; icon: React.ElementType; docs: PDFDocument[] }[] = [
  {
    ...
    icon: BookOpen,
    docs: [
      { name: "Vol I — Master Complete Edition (EN)", path: "/documents/GRGF™_Vol1_Master_Complete_Edition.pdf", description: "438+ pages — Definitive consolidated reference" },
      { name: "Vol I — Édition Complète (FR)", path: "/documents/GRGF™_Vol1_Master_Complete_Edition_FR.pdf" },
      { name: "Vol I — الطبعة الكاملة (AR)", path: "/documents/GRGF™_Vol1_Master_Complete_Edition_AR.pdf" },
      { name: "Vol II — Technical & Architecture Blueprints (EN)", path: "/documents/GRGF™_Vol2_Technical_Architecture_Blueprints.pdf", description: "566+ pages — Six-Layer Deterministic Architecture" },
      { name: "Vol II — Modèles Techniques (FR)", path: "/documents/GRGF™_Vol2_Technical_and_Architecture_Blueprints_FR.pdf" },
      { name: "Vol II — المخططات التقنية (AR)", path: "/documents/GRGF™_Vol2_Technical_and_Architecture_Blueprints_AR.pdf" },
      { name: "Vol III — Academy, Training & Certification (EN)", path: "/documents/GRGF™_Vol3_Academy_Training_Certification.pdf", description: "702+ pages — 4-Tier Certification Model" },
      { name: "Vol III — Académie et Formation (FR)", path: "/documents/GRGF™_Vol3_Academy_Training_and_Certification_FR.pdf" },
      { name: "Vol III — الأكاديمية والتدريب (AR)", path: "/documents/GRGF™_Vol3_Academy_Training_and_Certification_AR.pdf" },
      { name: "Vol IV — Standards & Compliance Reference (EN)", path: "/documents/GRGF™_Vol4_Standards_Compliance_Reference.pdf", description: "878+ pages — 12+ International Standards" },
      { name: "Vol IV — Normes et Conformité (FR)", path: "/documents/GRGF™_Vol4_Standards_and_Compliance_Reference_FR.pdf" },
      { name: "Vol IV — المعايير والامتثال (AR)", path: "/documents/GRGF™_Vol4_Standards_and_Compliance_Reference_AR.pdf" },
    ],
  },
  {
    id: "sovereign",
    ...
    icon: Landmark,
    docs: [
      { name: "Sovereign Authority Edition 2026 (EN)", path: "/documents/GRGF™_Sovereign_Authority_Edition_2026.pdf", description: "Inventor-Controlled Stewardship Model" },
      { name: "Édition Autorité Souveraine (FR)", path: "/documents/GRGF™_Sovereign_Authority_Edition_2026_FR.pdf" },
      { name: "طبعة السلطة السيادية (AR)", path: "/documents/GRGF™_Sovereign_Authority_Edition_2026_AR.pdf" },
      { name: "Complete Proposal 2026 Expanded (EN)", path: "/documents/GRGF™_Complete_Proposal_2026_Expanded.pdf", description: "Full expanded institutional proposal" },
      { name: "Proposition Complète (FR)", path: "/documents/GRGF™_Complete_Proposal_2026_Expanded_FR.pdf" },
      { name: "الاقتراح الكامل (AR)", path: "/documents/GRGF™_Complete_Proposal_2026_Expanded_AR.pdf" },
      { name: "Value Proposition Complete 2026 (EN)", path: "/documents/GRGF™_Value_Proposition_Complete_2026.pdf", description: "$18.3B–$96.2B projections across 6 stakeholder categories" },
      { name: "Proposition de Valeur (FR)", path: "/documents/GRGF™_Value_Proposition_Complete_2026_FR.pdf" },
      { name: "عرض القيمة (AR)", path: "/documents/GRGF™_Value_Proposition_Complete_2026_AR.pdf" },
      { name: "126 Applications Catalog (EN)", path: "/documents/GRGF™_126_Applications_Complete_2026.pdf", description: "126 apps across 12 sectors — $61.7B annual value" },
      { name: "Catalogue 126 Applications (FR)", path: "/documents/GRGF™_126_Applications_Complete_2026_FR.pdf" },
      { name: "كتالوج 126 تطبيق (AR)", path: "/documents/GRGF™_126_Applications_Complete_2026_AR.pdf" },
    ],
  },
  {
    id: "executive",
    ...
    docs: [
      ...
      { name: "Executive Summary — LinkedIn Brief", path: "/documents/GRGF™_Executive_Summary_LinkedIn_Brief.pdf" },
      { name: "Résumé Exécutif LinkedIn (FR)", path: "/documents/GRGF™_Resume_Executif_LinkedIn_FR.pdf" },
      { name: "One Pager (EN)", path: "/documents/GRGF™_One_Pager.pdf", description: "Single-page overview for rapid briefing" },
      { name: "Une Page (FR)", path: "/documents/GRGF™_Une_Page_FR.pdf" },
      { name: "Public Overview", path: "/documents/GRGF™_Public_Overview.pdf" },
      { name: "Level 1 — Public Overview (MaxDepth)", path: "/documents/GRGF™_Level1_Public_Overview_MaxDepth.pdf" },
      { name: "Niveau 1 — Aperçu Public (FR)", path: "/documents/GRGF™_Niveau1_Apercu_Public_MaxDepth_FR.pdf" },
      { name: "Level 2 — Institutional Review (MaxDepth)", path: "/documents/GRGF™_Level2_Institutional_Review_MaxDepth.pdf" },
      { name: "Niveau 2 — Examen Institutionnel (FR)", path: "/documents/GRGF™_Niveau2_Examen_Institutionnel_MaxDepth_FR.pdf" },
      { name: "Oral Defense Briefing Deck", path: "/documents/Oral_Defense_Briefing_Deck.pdf", description: "Problem → Solution → Value → Ask" },
      { name: "Phase 3 Visual Operating Model", path: "/documents/GRGF™_Phase_3_Visual_Operating_Model.pdf" },
      { name: "Vision and Purpose", path: "/documents/GRGF™_Vision_and_Purpose.pdf" },
      { name: "FAQ", path: "/documents/GRGF™_FAQ.pdf" },
      { name: "Master Binder v1", path: "/documents/GRGF™_Master_Binder_v1.pdf" },
    ],
  },
  {
    id: "technical",
  ...
  },
  {
    ...
    icon: GraduationCap,
    docs: [
      { name: "NDA Template", path: "/documents/templates/GRGF™_NDA_Template.pdf" },
      { name: "Pilot MOU Template", path: "/documents/templates/GRGF™_Pilot_MOU_Template.pdf" },
      { name: "Licensing Agreement Template", path: "/documents/templates/GRGF™_Licensing_Agreement_Template.pdf" },
      { name: "Partnership Agreement Template", path: "/documents/templates/GRGF™_Partnership_Agreement_Template.pdf" },
      { name: "Data Processing Agreement", path: "/documents/templates/GRGF™_Data_Processing_Agreement.pdf" },
      { name: "SLA Template", path: "/documents/templates/GRGF™_SLA_Template.pdf" },
      { name: "RFP Template", path: "/documents/templates/GRGF™_RFP_Template.pdf" },
      { name: "Project Charter Template", path: "/documents/templates/GRGF™_Project_Charter_Template.pdf" },
      { name: "Budget Template", path: "/documents/templates/GRGF™_Budget_Template.pdf" },
      { name: "Risk Assessment Form", path: "/documents/templates/GRGF™_Risk_Assessment_Form.pdf" },
      { name: "Compliance Checklist", path: "/documents/templates/GRGF™_Compliance_Checklist.pdf" },
      { name: "Communication Plan", path: "/documents/templates/GRGF™_Communication_Plan.pdf" },
      { name: "Change Management Plan", path: "/documents/templates/GRGF™_Change_Management_Plan.pdf" },
      { name: "Stakeholder Engagement Plan", path: "/documents/templates/GRGF™_Stakeholder_Engagement_Plan.pdf" },
      { name: "Evaluation Scorecard", path: "/documents/templates/GRGF™_Evaluation_Scorecard.pdf" },
      { name: "Incident Report Form", path: "/documents/templates/GRGF™_Incident_Report_Form.pdf" },
      { name: "Institutional Brochure", path: "/documents/templates/GRGF™_Institutional_Brochure.pdf" },
      { name: "Training Manual Template", path: "/documents/templates/GRGF™_Training_Manual_Template.pdf" },
    ],
  },
];
...
const ArchiveDownloads = () => {
  ...
  const handleBulkDownload = async (catId: string, label: string, docs: PDFDocument[]) => {
    ...
    try {
      ...
      saveAs(content, `GRGF™_${label.replace(/[^a-zA-Z0-9]/g, "_")}.zip`);
    } catch {
