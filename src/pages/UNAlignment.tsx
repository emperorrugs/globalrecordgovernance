  ...
  <div className="animate-fade-in">
    <header className="border-b border-border px-6 py-20 md:px-12 lg:px-20 bg-primary text-primary-foreground">
      <div className="max-w-5xl mx-auto">
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">United Nations Alignment</p>
        <h1 className="institutional-heading text-display font-semibold text-primary-foreground mb-4">
          UN SDG Impact & Digital Public Goods
        </h1>
        <p className="text-body-lg text-primary-foreground/60 max-w-2xl">
          Alignment with UN Sustainable Development Goals, Digital Public Goods Alliance criteria, E-Government Development Index standards, and the UN Secretary-General's Roadmap for Digital Cooperation.
        </p>
      </div>
    </header>
    ...
    <Sec className="border-b border-border">
      <FadeIn>
        ...
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">Sustainable Development Goals Impact</h2>
    ...
    <Sec className="border-b border-border bg-muted/40">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Digital Public Goods Alliance</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-4">DPG Standard Compliance</h2>
        <p className="text-body text-muted-foreground mb-8 max-w-3xl">
          Assessment against the Digital Public Goods Alliance's 9-point standard for recognition as a Digital Public Good (DPG).
        </p>
        <div className="space-y-3">
          {dpgCriteria.map((c, i) => (
    ...
    <Sec className="border-b border-border">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Digital Cooperation</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">UN Secretary-General's Roadmap Alignment</h2>
    ...
    <Sec className="border-b border-border bg-muted/40">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">E-Government</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">E-Government Development Index (EGDI)</h2>
    ...
    <Sec className="bg-primary text-primary-foreground">
      <FadeIn>
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="font-serif text-heading-1 font-semibold text-primary-foreground mb-4">UN Agency Engagement</h2>
          <p className="text-body text-primary-foreground/60 mb-8">
            For UN agencies, DPGA members, or SDG-aligned institutions seeking governance integrity infrastructure for development programmes.
          </p>
          <Link to="/controlled-access" className="inline-flex items-center gap-2 px-8 py-4 bg-accent text-accent-foreground text-sm font-semibold tracking-wide transition-all hover:shadow-lg hover:shadow-accent/20">
            Request Institutional Brief <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </FadeIn>
    </Sec>
