    ...
    <div className="animate-fade-in">
      <header className="border-b border-border px-6 py-20 md:px-12 lg:px-20 bg-primary text-primary-foreground">
        <div className="max-w-5xl mx-auto">
          <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">{t("itu.overline")}</p>
      ...
      <Sec className="border-b border-border">
        <FadeIn>
          <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">{t("itu.standards")}</p>
          <h2 className="institutional-heading text-heading-1 font-semibold mb-8">{t("itu.standards_title")}</h2>
      ...
      <Sec className="border-b border-border bg-muted/40">
        <FadeIn>
          <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">{t("itu.wsis")}</p>
          <h2 className="institutional-heading text-heading-1 font-semibold mb-8">{t("itu.wsis_title")}</h2>
      ...
      <Sec className="border-b border-border">
        <FadeIn>
          <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">{t("itu.regional")}</p>
          <h2 className="institutional-heading text-heading-1 font-semibold mb-8">{t("itu.regional_title")}</h2>
          <div className="space-y-4">
      ...
      <Sec className="border-b border-border bg-muted/40">
        <FadeIn>
          <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">{t("itu.multilateral")}</p>
          <h2 className="institutional-heading text-heading-1 font-semibold mb-8">{t("itu.multilateral_title")}</h2>
      ...
      <Sec className="bg-primary text-primary-foreground">
        <FadeIn>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="font-serif text-heading-1 font-semibold text-primary-foreground mb-4">{t("itu.engagement")}</h2>
            <p className="text-body text-primary-foreground/60 mb-8">
              {t("itu.engagement_desc")}
            </p>
            <Link to="/controlled-access" className="inline-flex items-center gap-2 px-8 py-4 bg-accent text-accent-foreground text-sm font-semibold tracking-wide transition-all hover:shadow-lg hover:shadow-accent/20">
              {t("itu.request_brief")} <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </FadeIn>
      </Sec>
