  ...
  <div className="animate-fade-in">
    <header className="border-b border-border px-6 py-20 md:px-12 lg:px-20 bg-primary text-primary-foreground">
      <div className="max-w-5xl mx-auto">
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">UNESCO Alignment</p>
        <h1 className="institutional-heading text-display font-semibold text-primary-foreground mb-4">
          UNESCO Digital Governance Standards
        </h1>
        <p className="text-body-lg text-primary-foreground/60 max-w-2xl">
          Alignment with UNESCO's Internet Universality ROAM-X Indicators, Recommendation on the Ethics of AI, Information for All Programme (IFAP), and Memory of the World documentary heritage standards.
        </p>
      </div>
    </header>
    ...
    <Sec className="border-b border-border">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">ROAM-X Framework</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-4">Internet Universality ROAM-X Indicators</h2>
        <p className="text-body text-muted-foreground mb-8 max-w-3xl">
          UNESCO's ROAM-X framework assesses digital ecosystems across five dimensions. GRGF alignment demonstrates governance infrastructure that strengthens each dimension.
        </p>
    ...
    <Sec className="border-b border-border bg-muted/40">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">AI Ethics</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-4">UNESCO Recommendation on AI Ethics</h2>
        <p className="text-body text-muted-foreground mb-8 max-w-3xl">
          The first global normative instrument on AI ethics, adopted by all 193 UNESCO Member States in 2021. GRGF aligns with all eight core principles as governance infrastructure.
        </p>
    ...
    <Sec className="border-b border-border">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Internet for Trust</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">Guidelines for Digital Platform Regulation</h2>
    ...
    <Sec className="border-b border-border bg-muted/40">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Documentary Heritage</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">Information Preservation & Access</h2>
    ...
    <Sec className="border-b border-border">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">IFAP Programme</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">Information for All Programme Alignment</h2>
    ...
    <Sec className="bg-primary text-primary-foreground">
      <FadeIn>
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="font-serif text-heading-1 font-semibold text-primary-foreground mb-4">UNESCO Engagement</h2>
          <p className="text-body text-primary-foreground/60 mb-8">
            For UNESCO National Commissions, IFAP committees, or institutions seeking governance infrastructure aligned with UNESCO's digital governance and information preservation standards.
          </p>
          <Link to="/controlled-access" className="inline-flex items-center gap-2 px-8 py-4 bg-accent text-accent-foreground text-sm font-semibold tracking-wide transition-all hover:shadow-lg hover:shadow-accent/20">
            Request UNESCO Alignment Brief <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </FadeIn>
    </Sec>
