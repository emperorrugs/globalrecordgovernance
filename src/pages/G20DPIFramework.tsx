  ...
  <div className="animate-fade-in">
    <header className="border-b border-border px-6 py-20 md:px-12 lg:px-20 bg-primary text-primary-foreground">
      <div className="max-w-5xl mx-auto">
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">G20 DPI Framework</p>
        <h1 className="institutional-heading text-display font-semibold text-primary-foreground mb-4">
          G20 Digital Public Infrastructure Alignment
        </h1>
        <p className="text-body-lg text-primary-foreground/60 max-w-2xl">
          Mapping GRGF capabilities to the G20 Framework for Digital Public Infrastructure, the India Stack model, and the Co-Develop bilateral initiative for inclusive DPI deployment.
        </p>
      </div>
    </header>
    ...
    <Sec className="border-b border-border">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Core Principles</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">G20 DPI Principles Alignment</h2>
    ...
    <Sec className="border-b border-border bg-muted/40">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">DPI Stack Position</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">GRGF as the Governance Integrity Layer</h2>
    ...
    <Sec className="border-b border-border">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Co-Develop Initiative</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">Complementary DPI Integration</h2>
    ...
    <Sec className="border-b border-border bg-muted/40">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Comparative Analysis</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">GRGF vs. India Stack Model</h2>
    ...
    <Sec className="bg-primary text-primary-foreground">
      <FadeIn>
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="font-serif text-heading-1 font-semibold text-primary-foreground mb-4">G20 DPI Engagement</h2>
          <p className="text-body text-primary-foreground/60 mb-8">
            For G20 working groups, DPI task forces, or national digital transformation offices evaluating governance integrity infrastructure.
          </p>
          <Link to="/controlled-access" className="inline-flex items-center gap-2 px-8 py-4 bg-accent text-accent-foreground text-sm font-semibold tracking-wide transition-all hover:shadow-lg hover:shadow-accent/20">
            Request Framework Assessment <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </FadeIn>
    </Sec>
