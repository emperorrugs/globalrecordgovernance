  ...
  <div className="animate-fade-in">
    <header className="border-b border-border px-6 py-20 md:px-12 lg:px-20 bg-primary text-primary-foreground">
      <div className="max-w-5xl mx-auto">
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">World Bank Alignment</p>
        <h1 className="institutional-heading text-display font-semibold text-primary-foreground mb-4">
          GovTech Maturity & Digital Government Readiness
        </h1>
        <p className="text-body-lg text-primary-foreground/60 max-w-2xl">
          Comprehensive alignment mapping between GRGF capabilities and World Bank GovTech Maturity Index (GTMI), Digital Government Readiness Assessment, and institutional capacity frameworks.
        </p>
      </div>
    </header>
    ...
    <Sec className="border-b border-border">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Global Impact Context</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">Why the World Bank Cares</h2>
    ...
    <Sec className="border-b border-border bg-muted/40">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">GTMI Alignment</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">GovTech Maturity Index Mapping</h2>
    ...
    <Sec className="border-b border-border">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Digital Development</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">World Bank Digital Development Principles</h2>
    ...
    <Sec className="border-b border-border bg-muted/40">
      <FadeIn>
        <p className="text-overline font-mono text-accent uppercase tracking-widest mb-4">Institutional Value</p>
        <h2 className="institutional-heading text-heading-1 font-semibold mb-8">Value Proposition for Development Finance</h2>
    ...
    <Sec className="bg-primary text-primary-foreground">
      <FadeIn>
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="font-serif text-heading-1 font-semibold text-primary-foreground mb-4">Development Partnership</h2>
          <p className="text-body text-primary-foreground/60 mb-8">
            For World Bank country teams, development finance institutions, or governance reform programmes seeking structural accountability infrastructure.
          </p>
